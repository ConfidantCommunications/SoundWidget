...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/soundOff.png", NME_assets_soundoff_png);
			resourceTypes.set ("assets/soundOff.png", "image");
			resourceClasses.set ("assets/soundOn.png", NME_assets_soundon_png);
			resourceTypes.set ("assets/soundOn.png", "image");

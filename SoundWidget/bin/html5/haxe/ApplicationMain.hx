import ca.confidant.soundWidget.Main;
...
class ApplicationMain {
	...
	public static function main () {
		...
		loaders.set ("assets/soundOff.png", loader);
		total ++;
		
		
		var loader:Loader = new Loader ();
		loaders.set ("assets/soundOn.png", loader);
		total ++;
   ...
   public static function getAsset(inName:String):Dynamic {
		...
		if (inName=="assets/soundOff.png") {
			
			return Assets.getBitmapData ("assets/soundOff.png");
			
		}
		
		if (inName=="assets/soundOn.png") {
			
			return Assets.getBitmapData ("assets/soundOn.png");
